        ...
        <form id="search-form" novalidate>
          <fieldset id="config-fields">
            ...
            <details class="advanced-details"><summary>Controles avançados <span>LIMITES & HISTÓRICO</span></summary><div class="details-content advanced-grid">
              ...
              <div class="field-row"><label for="batch-size">Tamanho máximo do lote</label><input id="batch-size" name="batchSize" type="number" min="1" max="16777216" value="65536"></div>
...
const defaults = { name: '', target: '0x9c2f44efad0c1e852a09df9939e6daf061140caf', mode: 'batches', pattern: '? ? ? ? ? ? ? ? ? ? ? ?', pool: '', fill: '', post: 'dutch@1 fiber fork', video: 'fog@5 parrot@12', backend: 'auto', language: 'english', maxCandidates: '100000', batchSize: 65536, threads: 0, adaptive: false, noChecksum: false, excludeRo1: true, excludeRecords: [] };
